...
Connecting third-party accounts (for example, Google Tag Manager)
Some Yahoo B2B Services let you connect a third-party account, such as Google, to view and manage that account’s own resources — for example, connecting your Google account in Yahoo DSP to install or publish a tag into a Google Tag Manager container you select.
If you choose to use this feature, the Google Tag Manager and account-email scopes are all that are needed for this feature, not Gmail, Drive, Calendar, or other Google data. Information is accessed over an encrypted connection solely to complete the action you request, and never for advertising, profiling, or to train AI models. We do not sell, share, or disclose it to third parties.
This information exists only in your browser for your session and is not stored by Yahoo. It is cleared when you disconnect or your session ends. Resources you create through this feature, such as tags, remain in your own third-party account, which you manage and delete there.
