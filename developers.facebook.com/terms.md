...
i. If any of the following incidents happen, you must notify us using this form as soon as practicable but no later than required under applicable laws and regulations and provide us with information we request regarding:
...
iii. Annex II: Technical and organizational measures: For the purposes of Annex II, you will implement and maintain the Technical and Organisational Measures.
...
a. In accordance with our Terms of Service, you will not transfer any of your rights or obligations under these Terms to anyone else without our consent. Transferring can include assignment, acquisition, merger, change of control, or other forms of transfer. For any such transfer, you must update the App Dashboard and the Business Manager.
...
h. “Global Data Transfer Addendum” means the terms available at https://facebook.com/legal/terms/Privacy/GDTA.
...
p. “Restricted Platform Data” means Platform Data that (i) reasonably can be used to identify a particular User or device; (ii) is accessed using the permissions listed here; or (iii) we otherwise designate as Restricted. Notwithstanding the foregoing, Restricted Platform Data does not include data that can be accessed using the permissions listed here.
